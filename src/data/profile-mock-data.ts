...
export const mockProfilesExpanded: BotProfile[] = [
  {
    ...
    restoreLoginScreenRequirement: requirement(false, "runtime_blocked", "Orphan challenge not confirmed", "Restore login screen is only available when an orphan email-code challenge is confirmed for this assigned clone."),
